defmodule RehoboamGraphQl.Resolver.UserIdentity do
  alias Potionx.Context.Service
  alias Rehoboam.UserIdentities.UserIdentityService
  ...
  def data do
    Dataloader.Ecto.new(Rehoboam.Repo, query: &UserIdentityService.query/2)
  end
